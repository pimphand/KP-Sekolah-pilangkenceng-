...
class MapelController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/data-mapel/SDN-Sumbergandu')->with('sukses','Data Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, Mapel $mapel)
    {
        ...
        return redirect('/data-mapel/SDN-Sumbergandu')->with('sukses','Data Berhasil Diperbarui');
    }
    ...
    public function destroy(Mapel $mapel)
    {
        ...
        return redirect('/data-mapel/SDN-Sumbergandu')->with('sukses', 'Data Berhasil Dihapus');
    }
}
