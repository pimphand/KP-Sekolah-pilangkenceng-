...
class BukuIndukController extends Controller
{
    ...
    public function update(Request $request, BukuInduk $bukuinduk)
    {
        ...
        return redirect('/data-buku-induk/SDN-Sumbergandu')->with('sukses','Data Berhasil Diperbarui');
    }
    ...
    public function destroy(BukuInduk $bukuinduk)
    {
        ...
        return redirect('/data-buku-induk/SDN-Sumbergandu')->with('sukses','Data Berhasil Dihapus');
    }
}
