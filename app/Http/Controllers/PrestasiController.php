...
class PrestasiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/Prestasi/SDN-Sumbergandu')->with('sukses','Data Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, Prestasi $prestasi)
    {
        ...
        return redirect('/Prestasi/SDN-Sumbergandu')->with('sukses','Data Berhasil Diperbarui');
    }
    ...
    public function destroy(Prestasi $prestasi)
    {
        ...
        return redirect('/Prestasi/SDN-Sumbergandu')->with('sukses','Data Berhasil Dihapus');
    }
