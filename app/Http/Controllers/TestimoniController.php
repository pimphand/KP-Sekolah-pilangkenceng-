...
class TestimoniController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/testimoni-alumni/SDN-Sumbergandu')->with('sukses','Data Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, Testimoni $testimoni)
    {
        ...
        return redirect('/testimoni-alumni/SDN-Sumbergandu')->with('sukses','Data Berhasil Diperbarui');
    }
    ...
    public function destroy(Testimoni $testimoni)
    {
        ...
        return redirect('/testimoni-alumni/SDN-Sumbergandu')->with('sukses','Data Berhasil Dihapus');
    }
