...
class SiswaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/data-siswa/SDN-Sumbergandu')->with('sukses','Data Berhasil Ditambahkan');
    ...
    public function update(Request $request, Siswa $siswa)
    {
        ...
        return redirect('/data-siswa/SDN-Sumbergandu')->with('sukses','Data Berhasil Diperbarui');
    }
    ...
    public function destroy(Siswa $siswa)
    {
        ...
        return redirect('/data-siswa/SDN-Sumbergandu')->with('sukses','Data Berhasil Dihapus');
    }
    ...
    public function addnilai(Request $request, $idsiswa)
    {
        $siswa = Siswa::find($idsiswa);
            if ($siswa->mapel()->where('mapel_id',$request->mapel)->exists()) {
                return redirect('/profile-siswa/'.$idsiswa.'/SDN-Sumbergandu')->with('error','Nilai Mata Pelajaran Sudah Ada');
            }

        $siswa->mapel()->attach($request->mapel, ['nilai' => $request->nilai]);

        return redirect('/profile-siswa/'.$idsiswa.'/SDN-Sumbergandu')->with('sukses','Data Berhasil Dimasukkan');
    }
