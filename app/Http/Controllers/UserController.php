...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/Data-Users/SDN-Sumbergandu')->with('sukses','Data Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect('/Data-Users/SDN-Sumbergandu')->with('sukses','Data Berhasil Diperbarui');
    }
    ...
    public function updateav(Request $request, $id)
    {
        ...
        return redirect('/Profile-Users/'.$id.'/SDN-Sumbergandu')->with('sukses','Foto Profile Berhasil Diganti');
    ...
    public function updatepassword(Request $request, $id)
    {
        ...
        return redirect('/Data-Users/SDN-Sumbergandu')->with('sukses','Password Berhasil Diganti');
    ...
    public function updtpassusers(Request $request, $id)
    {
        ...
        $newPassword = $request->newPasword;
            ...
            if (!Hash::check($oldPassword, Auth::user()->password)) {
                return redirect('/edit-password-users/'.$id.'/SDN-Sumbergandu')->with('error','Password Lama Tidak Sesuai');
            }else{
                 $request->user()->fill([
                        'password' => Hash::make($request->newPassword)
                    ])->save();

                return redirect('/Profile-Users/'.$id.'/SDN-Sumbergandu')->with('sukses','Password Berhasil Diganti');
            }
    }
    ...
    public function resetpw(Request $request, $id)
    {
        ...
        return redirect('/Data-Users/SDN-Sumbergandu')->with('sukses','Password Diperbarui Kedefault');
    }
    ...
    public function destroy(User $user)
    {
        ...
        return redirect('Data-Users/SDN-Sumbergandu')->with('sukses','Data Berhasil Dihapus');
    }
