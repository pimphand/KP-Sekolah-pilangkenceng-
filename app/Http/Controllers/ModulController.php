...
class ModulController extends Controller
{
 	...
 	public function update(Request $request, Modul $modul)
 	{
        ...
        $this->validate($request, [
 		...
 		return redirect('/modul-pelajaran/SDN-Sumbergandu')->with('sukses','Data Berhasil Diperbarui');
 	}
 	...
 	public function store(Request $request)
 	{
        ...
        $modul = Modul::create([
 		...
 		return redirect('/modul-pelajaran/SDN-Sumbergandu')->with('sukses','Data Berhasil Ditambahkan');
 	}
 	...
 	public function destroy(Modul $modul)
 	{
        unlink('files/'.$modul->data);
 		...
 		return redirect('/modul-pelajaran/SDN-Sumbergandu')->with('sukses','Data Berhasil Dihapus');
 	}
