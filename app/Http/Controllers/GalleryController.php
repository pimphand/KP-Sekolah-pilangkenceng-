...
class GalleryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/Gallery/SDN-Sumbergandu')->with('sukses','Data Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, Gallery $gallery)
    {
        ...
        return redirect('/Gallery/SDN-Sumbergandu')->with('sukses','Data Berhasil Diperbarui');
    }
    ...
    public function destroy(Gallery $gallery)
    {
        ...
        return redirect('/Gallery/SDN-Sumbergandu')->with('sukses','Data Berhasil Dihapus');
    }
