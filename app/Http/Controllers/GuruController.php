...
class GuruController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/data-guru/SDN-Sumbergandu')->with('sukses','Data Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, Guru $guru)
    {
        ...
        return redirect('data-guru/SDN-Sumbergandu')->with('sukses','Data Berhasil Diperbarui');
    }
    ...
    public function destroy(Guru $guru)
    {
        ...
        return redirect('data-guru/SDN-Sumbergandu')->with('sukses','Data Berhasil Dihapus');
    }
