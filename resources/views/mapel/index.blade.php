...
@section('title')
	Data Mata Pelajaran | SD Negeri Sumbergandu
@stop
					...
					<div class="panel">
						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="col-md-3">
									<form class="" method="GET" action="/data-mapel/SDN-Sumbergandu">
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>{{ $mp->nama }}</td>
											<td>{{ $mp->semester }}</td>
											<td><a href="/profile-guru/{{ $mp->guru->id }}/SDN-Sumbergandu">{{ $mp->guru->nama_lengkap }}</a></td>
											<td>
												<a href="/edit-mapel/{{$mp->id}}/SDN-Sumbergandu" class="btn btn-warning btn-sm"><i class="lnr lnr-pencil"></i></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       	<form method="POST" action="/store-mapel/SDN-Sumbergandu">
       		@csrf
	...
	<script type="text/javascript">
		$('.delete').click(function(){
			...
			swal({
				...
				.then((willDelete) => {
				  if (willDelete) {
				  	window.location = "/destroy-mapel/"+mp_id+"/SDN-Sumbergandu";
				  }
				});
		});
	</script>
