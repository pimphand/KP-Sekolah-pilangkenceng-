				...
				<div class="col-md-12">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Publish SDN-Sumbergandu</h3>
						</div>
							...
							<div class="tab-content">
								<div class="tab-pane fade active in" id="tab-bottom-left1">
									<div class="row">
										...
										<div class="col-md-3">
											<form class="" method="GET" action="/Publish/SDN-Sumbergandu">
	...
	<script type="text/javascript">
		...
		$('.delete').click(function(){
			...
			swal({
				...
				.then((willDelete) => {
				  if (willDelete) {
				  	window.location = "/publish-destroy/"+ps_id+"/SDN-Sumbergandu";
				  }
				});
		});
