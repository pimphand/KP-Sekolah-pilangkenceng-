...
@section('title')
	Data Siswa | SD Negeri Sumbergandu
@stop
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="/profile-siswa/{{$r->id}}/SDN-Sumbergandu">{{ $r->nis }}</a></td>
											<td><a href="/profile-siswa/{{$r->id}}/SDN-Sumbergandu">{{ $r->nama_lengkap }}</a></td>
											<td>{{ $r->jenis_kelamin }}</td>
											<td>{{ $r->kelas }}</td>
											<td>{{ $r->rank() }}</td>
											@if(auth()->user()->role == 'Admin')
											<td>
												<a href="/edit-siswa/{{$r->id}}/SDN-Sumbergandu" class="btn btn-warning btn-sm"><i class="lnr lnr-pencil"></i></a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
	      <form method="POST" action="/store-siswa/SDN-Sumbergandu" enctype="multipart/form-data">
	      	@csrf
	       	<div class="row">
	...
	<script type="text/javascript">
		$('.delete').click(function(){
			...
			swal({
				...
				.then((willDelete) => {
				  if (willDelete) {
				  	window.location = "/destroy-siswa/"+siswa_id+"/SDN-Sumbergandu";
				  }
				});
		});
