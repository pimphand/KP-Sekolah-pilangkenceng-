...
@section('title')
	Data Guru | SD Negeri Sumbergandu
@stop
					...
					<div class="panel">
						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="col-md-3">
									<form class="" method="GET" action="/data-guru/SDN-Sumbergandu">
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="/profile-guru/{{$r->id}}/SDN-Sumbergandu">{{ $r->nig }}</a></td>
											<td><a href="/profile-guru/{{$r->id}}/SDN-Sumbergandu">{{ $r->nama_lengkap }}</a></td>
											...
											@if(auth()->user()->role == 'Admin')
											<td>
												<a href="/edit-guru/{{$r->id}}/SDN-Sumbergandu" class="btn btn-warning btn-sm"><i class="lnr lnr-pencil"></i></a>
	...
	<script type="text/javascript">
		$('.delete').click(function(){
			...
			swal({
				...
				.then((willDelete) => {
				  if (willDelete) {
				  	window.location = "/destroy-guru/"+guru_id+"/SDN-Sumbergandu";
				  }
				});
		});
