...
@section('title')
	Data Users | SD Negeri Sumbergandu
@stop
					...
					<div class="panel">
						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="col-md-3">
									<form class="" method="GET" action="/Data-Users/SDN-Sumbergandu">
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="/edit-users/{{$us->id}}/SDN-Sumbergandu" class="btn btn-warning btn-sm"><i class="lnr lnr-pencil"></i></a>
												@if($us->role == 'Guru')
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       	<form method="POST" action="/store-users/SDN-Sumbergandu" enctype="multipart/form-data">
       		@csrf
	...
	<script type="text/javascript">
		$('.delete').click(function(){
			...
			swal({
				...
				.then((willDelete) => {
				  if (willDelete) {
				  	window.location = "/destroy-users/"+us_id+"/SDN-Sumbergandu";
				  }
				});
		});
	</script>
	...
	<script type="text/javascript">
		$('.reset').click(function(){
			...
			swal({
				...
				.then((willDelete) => {
				  if (willDelete) {
				  	window.location = "/reset-password/"+rs_id+"/SDN-Sumbergandu";
				  }
				});
		});
