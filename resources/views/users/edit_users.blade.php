				...
				<div class="col-md-12">
					...
					<div class="panel">
						<div class="panel-heading">
							...
							<div class="right">
								<a href="/edit-password/{{$us->id}}/SDN-Sumbergandu" class="btn btn-sm btn-warning">Edit Password</a>
							</div>
							@endif
						</div>
						<div class="panel-body">
							<form method="POST" action="/update-users/{{$us->id}}/SDN-Sumbergandu" enctype="multipart/form-data">
					       		@csrf
