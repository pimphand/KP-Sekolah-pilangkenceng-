						...
						<!-- <div class="row">
							<div class="col-md-6"> -->
								...
								<div class="panel-footer">
									<a href="/edit-password-users/{{$pu->id}}/SDN-Sumbergandu" class="btn btn-sm btn-warning">Ganti Password</a>
								</div>
							<!-- </div>
						</div> -->
					</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="/update-avatar/{{$pu->id}}/SDN-Sumbergandu" enctype="multipart/form-data">
      	@csrf
