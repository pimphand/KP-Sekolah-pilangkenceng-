...
@section('title')
	Testimoni | SD Negeri Sumbergandu
@stop
				...
				<div class="col-md-12">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Testimoni SDN-Sumbergandu</h3>
						</div>
						<div class="panel-body">
							...
							<div class="tab-content">
												...
												<table class="table table-striped">
													...
													<tbody>
														...
														<tr>
															...
															<td>{{ $r->lulusan }}</td>
															<td>
																<a href="/edit-testimoni/{{$r->id}}/SDN-Sumbergandu" class="btn btn-sm btn-warning"><i class="lnr lnr-pencil"></i></a>
								...
								<div class="tab-pane fade" id="tab-bottom-left2">
									<form method="POST" action="/store-testimoni/SDN-Sumbergandu" enctype="multipart/form-data">
										@csrf
	...
	<script type="text/javascript">
		$('.delete').click(function(){
			...
			swal({
				...
				.then((willDelete) => {
				  if (willDelete) {
				  	window.location = "/destroy-testimoni/"+ts_id+"/SDN-Sumbergandu";
				  }
				});
		});
