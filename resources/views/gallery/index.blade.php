				...
				<div class="col-md-12">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Gallery SDN-Sumbergandu</h3>
						</div>
							...
							<div class="tab-content">
								<div class="tab-pane fade active in" id="tab-bottom-left1">
									<div class="row">
										...
										<div class="col-md-3">
											<form class="" method="GET" action="/Gallery/SDN-Sumbergandu">
												...
												@forelse($gallery as $gr)
													<tr>
														...
														<td>
															...
															<a href="/edit-gallery/{{$gr->id}}/SDN-Sumbergandu" class="btn btn-sm btn-warning"><i class="lnr lnr-pencil"></i></a>
								...
								<div class="tab-pane fade" id="tab-bottom-left2">
									<form method="POST" action="/store-gallery/SDN-Sumbergandu" enctype="multipart/form-data">
										@csrf
	...
	<script type="text/javascript">
		$('.delete').click(function(){
			...
			swal({
				...
				.then((willDelete) => {
				  if (willDelete) {
				  	window.location = "/destroy-gallery/"+gr_id+"/SDN-Sumbergandu";
				  }
				});
		});
